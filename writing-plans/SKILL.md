...
3. **Type consistency:** Do method signatures in later tasks match what was defined earlier?
...
- **REQUIRED SUB-SKILL (Subagent-Driven):** Use superpowers:subagent-driven-development
- **REQUIRED SUB-SKILL (Inline):** Use superpowers:executing-plans
