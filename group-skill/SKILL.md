...
| 2 | `preview-skill` | 素材预览与生产控制 | 打开预览页，查看生产线仪表盘，按分类一键触发生产 |
...
> **💡 推荐工作方式：** 执行完 extract-skill 后，执行 preview-skill 打开 `素材库/preview.html`，预览页顶部有三个分类环形进度卡片（场景素材 / 道具+透明化 / TTS），点击卡片中的生产按钮会自动复制包含完整流程的 Copilot 指令到剪贴板。也可以按区块单独点击每个素材类别的生产按钮。
